...
export declare function getCategoriesController(_req: Request, res: Response, next: NextFunction): Promise<void>;
export declare function getCategoryController(req: Request, res: Response, next: NextFunction): Promise<void>;
