import { getAllSupplies, getSupplyById, createSupply, updateSupply, deleteSupply, getSuppliesByProduct, addSupplyToProduct, updateSupplyInProduct, removeSupplyFromProduct, } from '../services/supply.service.js';
export async function getSuppliesController(_req, res, next) {
    try {
...
export async function getSupplyController(req, res, next) {
    try {
...
export async function createSupplyController(req, res, next) {
    try {
...
export async function updateSupplyController(req, res, next) {
    try {
        const idParam = req.params.id;
        if (!idParam || typeof idParam !== 'string') {
            res.status(400).json({
...
export async function deleteSupplyController(req, res, next) {
    try {
        const idParam = req.params.id;
        if (!idParam || typeof idParam !== 'string') {
            res.status(400).json({
...
export async function getProductSuppliesController(req, res, next) {
    try {
...
export async function addSupplyToProductController(req, res, next) {
    try {
        const productIdParam = req.params.productId;
        if (!productIdParam || typeof productIdParam !== 'string') {
            res.status(400).json({
...
export async function updateSupplyInProductController(req, res, next) {
    try {
        const productIdParam = req.params.productId;
...
export async function removeSupplyFromProductController(req, res, next) {
    try {
        const productIdParam = req.params.productId;
        const supplyIdParam = req.params.supplyId;
        if (!productIdParam || typeof productIdParam !== 'string') {
