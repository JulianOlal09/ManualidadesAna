...
import { getCategoriesController, getCategoryController, createCategoryController, updateCategoryController, deleteCategoryController, toggleCategoryActiveController, } from '../controllers/category.controller.js';
...
router.patch('/categories/:id/toggle-active', verifyTokenMiddleware, requireRole(Role.ADMIN), toggleCategoryActiveController);
