          ...
          <div className="space-y-4">
            ...
            {!isAdmin && (
              <button
                ...
                className="w-full bg-gradient-to-r from-pink-500 to-purple-500 text-white py-3 rounded-lg font-semibold hover:from-pink-600 hover:to-purple-600 disabled:from-gray-400 disabled:to-gray-400 transition-all shadow-md"
              >
                {isAddingToCart
                  ? 'Agregando...'
                  : isOutOfStock
